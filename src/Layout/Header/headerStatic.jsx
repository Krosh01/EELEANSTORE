        ...
        <nav className='headerS__nav'>
          ...
          <li>
            <ul className='headerS__item'>
              <li><Link to='/Catalog' onClick={() => changeCategory('novelties')}>НОВИНИКИ</Link></li>
              <li><Link to='/Catalog' onClick={() => changeCategory('novelties')}>КАТЕГОРИИ</Link></li>
              <li><Link to='/Catalog' onClick={() => changeCategory('novelties')}>НАШИ КОЛЛЕКЦИИ</Link></li>
